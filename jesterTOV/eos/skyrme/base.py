...
class Skyrme_EOS_model(Interpolate_EOS_model):
    ...
    **Reference:** Skyrme (1959), Vautherin & Brink (1972)
    ...
    def construct_eos(
        self,
        params: dict,
        ngrids: Array | None = None,
        cs2grids: Array | None = None,
        ...
        Args:
            params (dict): Infinite nuclear matter parameters including:
                ...
                - **Kinf**: Incompressibility
                - **eNMhd**: Energy density at high density
            ngrids: Unused placeholder accepted for API compatibility with CSE/peakCSE
                EOS models and shared notebook helper code.
            cs2grids: Unused placeholder accepted for API compatibility with CSE/peakCSE
                EOS models and shared notebook helper code.
