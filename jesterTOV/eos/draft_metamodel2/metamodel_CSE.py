    ...
    def construct_eos(
        ...
        if return_extra or calculate_durca:
            ...
            metamodel = create_metamodel_for_extension(
                ...
                nmin_MM_nsat=self.metamodel.nmin_MM_nsat,
                nbreak=nbreak,
                ndat=self.metamodel.ndat,
                metamodel_kwargs={},
                proton_fraction_setting=proton_fraction_setting,
            )
            ...
            # Use pre-instantiated metamodel for efficiency
        ...
        # a fresh metamodel instance limited to nbreak when return_extra=True.
