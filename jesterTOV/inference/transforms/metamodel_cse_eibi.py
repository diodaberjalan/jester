...
class MetaModelCSETransform(JesterTransformBase):
    ...
    **kwargs
    ...
    def transform_func_MM_CSE(self, params: dict[str, Float]) -> dict[str, Float]:
        ...
        kappa_eibi = params["kappa_eibi"]
        Lambda_cosmo = 1.4657e-52
        eos_tuple = (ns, ps, hs, es, dloge_dlogps, cs2, kappa_eibi, Lambda_cosmo)

        # Solve the TOV equations
        logpc_EOS, masses_EOS, radii_EOS, Lambdas_EOS = self._solve_tov_eibi(eos_tuple)
